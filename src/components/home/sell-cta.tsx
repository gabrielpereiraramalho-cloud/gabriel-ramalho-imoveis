...
export function SellCta() {
  return (
    <section className="bg-brand-navy text-offwhite">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-start gap-4 px-4 py-10 sm:px-6 sm:py-14 lg:flex-row lg:items-center lg:justify-between lg:px-8">
